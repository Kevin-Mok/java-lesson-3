  ...
  return (
    <section className="space-y-3 rounded-xl border border-slate-700 bg-slate-900/50 p-4">
      ...
      <textarea
        ...
        rows={4}
        className="w-full rounded-md border border-slate-600 bg-slate-950 p-3 text-sm text-slate-100"
      ...
      <div aria-live="polite" className="space-y-2">
        ...
        >
          {questionState.checkAttempted
            ...
            : "Submit your answer to see teacher-style feedback."}
        </p>
